...
import com.winger.libgdx.main.sprite.TestAnimator;
import com.winger.libgdx.main.sprite.TestShapeRenderer;
import com.winger.libgdx.main.sprite.TestSprites;
import com.winger.libgdx.main.sprite.TestTiledSprites;
import com.winger.libgdx.main.sprite.TestTiledSprites2;
...
public class TestGdxGame extends ApplicationAdapter implements PageEventHandler
{
    ...
    public void create()
    {
        ...
        //
        Winger.texture.loadTexturesInDirectory("help/img");
        Winger.texture.loadTextureAtlas("help/atlas", "testAtlas");
        Winger.texture.loadTextureAtlas("help/atlas", "buttons");
        Winger.texture.loadTextureAtlas("help/atlas/libGdx-atlas", "images");
        PageManager.instance().addPagesInDirectory("help/test");
