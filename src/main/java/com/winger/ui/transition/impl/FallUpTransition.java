...
/**
 * Transition between pages by elements falling upwards
 *
 * @author Michael P. Wingfield
 * @copyright Nov 4, 2014
 *
 */
public class FallUpTransition extends Transition
{
    public FallUpTransition()
    {
    ...
    {
        FallUpTransition clone = new FallUpTransition();
