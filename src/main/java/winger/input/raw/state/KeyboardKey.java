...
public enum KeyboardKey
{
    ...
    private KeyboardKey(String character, String shiftCharacter, boolean isModifier, Integer index)
    {
    ...
    private KeyboardKey(String character, String shiftCharacter, Integer index)
    {
        this(character, shiftCharacter, false, index);
    }
    
    
    private KeyboardKey(String character, Integer index)
    {
        this(character, character.toUpperCase(), false, index);
    }
    
    
    private KeyboardKey(Integer index)
    {
        this("", "", true, index);
    }
    
    
    private KeyboardKey(KeyboardKey alternate)
    {
        this("", "", false, null);
